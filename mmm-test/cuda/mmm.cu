...
unordered_map<string, double> test_mm( int m, int k, int n){
    ...
    cudaMallocHost( (void**)&B, k*n* sizeof(et));
    cudaMallocHost( (void**)&C, m*n* sizeof(et));

    cudaMalloc( (void**)&dA, m*k* sizeof(et));
    cudaMalloc( (void**)&dB, k*n* sizeof(et));
    cudaMalloc( (void**)&dC, m*n* sizeof(et));
    ...
    cudaMemcpy(dA, A, m*k* sizeof(et), cudaMemcpyHostToDevice);
    cudaMemcpy(dB, B, k*n* sizeof(et), cudaMemcpyHostToDevice);
